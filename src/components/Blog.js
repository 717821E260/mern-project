  ...
  return (
    <div style={{ backgroundColor: 'white' }}>
      <BlogContainer>
        ...
        <p style={{ fontSize: '20px',backgroundColor:'white',marginTop:'-7em',fontStyle:"italic",color:'black' }}>
        Discover hidden gems from literary legends as their extraordinary stories unfold in
        </p>
        <p style={{fontStyle:"italic",backgroundColor:'white',fontSize:'20px'}}>
        this enchanting compendium.
        </p>
      </BlogContainer>
