  ...
  return (
    ...
    <Carousel  style={{padding:'100px',backgroundColor:'aliceblue' }}>
      ...
      <Carousel.Item>
        ...
        <h style={{fontSize:"70px",textAlign:'center',justifyContent:'center',alignItems:"center",marginRight: '10em'}}>Enchanting Literary Wonderland Imagination</h>
        <img
          className="d-block w-100"
          
          src="https://assets-global.website-files.com/64bdf2da73f4d7db826dcce3/64bf43d78d9a87a0c4e45c4d_literary-wonderland.jpg"
